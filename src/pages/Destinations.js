  ...
  const destinations = [
    ...
    },
    {
      ...
      images: [
        ...
        'https://images.unsplash.com/photo-1508131390442-f4b7b0e3b8a6?w=1920&h=1080&fit=crop',
    ...
    },
    {
      ...
      images: [
        ...
        'https://images.unsplash.com/photo-1577362627020-17b3b59141a7?w=1920&h=1080&fit=crop',
        'https://images.unsplash.com/photo-1539786776704-3a3d3b5cc40b?w=1920&h=1080&fit=crop',
    ...
    },
    {
      ...
      images: [
        ...
        'https://images.unsplash.com/photo-1508066618967-5b7a76eb8b9c?w=1920&h=1080&fit=crop',
        'https://images.unsplash.com/photo-1468436385273-8bcc5456ed45?w=1920&h=1080&fit=crop',
    ...
    },
    {
      ...
      images: [
        ...
        'https://images.unsplash.com/photo-1505460720656-ac38e4ac2dfa?w=1920&h=1080&fit=crop',
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-3 text-white">
                <button onClick={() => navigateMonth(-1)} className="p-1 hover:bg-gray-700 rounded">
                  <ChevronLeft className="w-5 h-5" />
                </button>
                <span className="font-medium text-sm sm:text-base">{monthNames[currentMonth.getMonth()]}, {currentMonth.getFullYear()}</span>
                <button onClick={() => navigateMonth(1)} className="p-1 hover:bg-gray-700 rounded lg:invisible">
                  <ChevronRight className="w-5 h-5" />
                </button>
              </div>
              <div className="grid grid-cols-7 gap-1 mb-2">
                {['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'].map(day => (
                  <div key={day} className="text-center text-gray-400 text-xs sm:text-sm py-1">{day}</div>
                ))}
              </div>
                ...
                {leftMonthDays.map((date, index) => (
                  <button
                    ...
                    className={`
                      ...
                      ${!date ? 'invisible' : ''}
                      ${date && isStartOrEndDate(date) ? 'bg-blue-500 text-white' : ''}
                      ${date && isDateInRange(date) && !isStartOrEndDate(date) ? 'bg-blue-500/20 text-white' : ''}
                      ${date && !isDateInRange(date) && !isStartOrEndDate(date) ? 'text-gray-300 hover:bg-gray-700' : ''}
                      ${date && date.toDateString() === new Date().toDateString() ? 'ring-1 ring-blue-400' : ''}
                    `}
                  >
                    {date?.getDate()}
                  </button>
            ...
            <div className="hidden lg:block flex-1">
              <div className="flex items-center justify-between mb-3 text-white">
                <div className="w-5" />
                <span className="font-medium">{monthNames[rightMonth.getMonth()]}, {rightMonth.getFullYear()}</span>
                <button onClick={() => navigateMonth(1)} className="p-1 hover:bg-gray-700 rounded">
                  <ChevronRight className="w-5 h-5" />
                </button>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 p-2">
                ...
                <div className="grid grid-cols-3 gap-2 md:hidden">
                  {selectedDestination.images.slice(3, 6).map((image, index) => (
                    <div key={index} className="relative h-24 overflow-hidden rounded-lg">
                      ...
                      {index === 2 && selectedDestination.images.length > 6 && (
                        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                          <span className="text-white font-medium">+{selectedDestination.images.length - 6}</span>
                        </div>
                      )}
                    </div>
                  ))}
                ...
                <div className="md:col-span-3 flex justify-center">
                  ...
                  >
                    ...
                    <span>Show all {selectedDestination.images.length} photos</span>
                  </button>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="text-sm text-gray-600">
                  {selectedDestination.images.length} photos • {selectedDestination.events.length} events
                </div>
              </div>
            </div>
            ...
            {filteredDestinations.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Try adjusting your search terms or date range to find more destinations.
                </p>
                <button
                  onClick={() => {
                    setSearchTerm('');
