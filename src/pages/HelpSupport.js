...
const HelpSupport = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Go to Account Settings > Billing and update your payment method or billing address. Changes take effect immediately."
    },
    {
    ...
    },
    {
      ...
      answer: "You can cancel your subscription anytime from Account Settings > Subscription. Your account will remain active until the end of your current billing period."
    },
    {
      question: "Is my data secure?",
      answer: "Yes, we use industry-standard encryption and security measures to protect your data. All data is encrypted both in transit and at rest."
    },
    {
      question: "How do I contact technical support?",
      answer: "You can reach our technical support team via the chat widget, email at support@company.com, or phone at +1-800-123-4567 during business hours."
    }
  ];
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-8"> 
      <div className=" mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-12 bg-white shadow-sm border-b">
          <h1 className="text-4xl font-bold text-gray-800 mb-4 ">Help & Support</h1>
          <p className="text-gray-600 text-lg">We're here to help you get the most out of our platform</p>
        </div>
