        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Have questions or need help planning your trip? We're here to assist you—reach out anytime!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="animate-fadeIn max-w-6xl mx-auto px-4 py-16">
            <div className="bg-white rounded-2xl shadow-lg p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-6">Data Protection Officer</h3>
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">
                              TravelEvents Pro - Privacy Office<br />
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-800 mb-6">Regional Contacts</h3>
                      
                      <div className="space-y-4">
                        <div className="bg-blue-50 p-4 rounded-lg">
                          <div className="flex items-center space-x-2 mb-2">
                            <span className="text-xl">🇪🇺</span>
                            <h4 className="font-semibold text-gray-800">European Union</h4>
                          </div>
                          <p className="text-blue-600 text-sm">eu-privacy@travelevents.com</p>
                        </div>
                        ...
                        <div className="bg-green-50 p-4 rounded-lg">
                          ...
                          <p className="text-green-600 text-sm">uk-privacy@travelevents.com</p>
                        </div>
                        
                        <div className="bg-purple-50 p-4 rounded-lg">
                          <div className="flex items-center space-x-2 mb-2">
                            <span className="text-xl">🌏</span>
                            <h4 className="font-semibold text-gray-800">Asia Pacific</h4>
                          </div>
                          <p className="text-purple-600 text-sm">apac-privacy@travelevents.com</p>
                        </div>
                      </div>
                    </div>
                  </div>
