...
import { MapPin, Calendar, Plane, Camera, Users, Heart, Award, ChevronRight, Globe, Compass, Mountain, Palmtree } from 'lucide-react';
  ...
  const values = [
    {
      icon: Compass,
      title: 'Adventure',
      description: 'We believe every journey should be an adventure that creates unforgettable memories and transforms perspectives.'
    },
    {
      icon: Heart,
      title: 'Cultural Connection',
      description: 'We connect travelers with authentic local experiences, fostering meaningful cultural exchanges worldwide.'
    },
    {
      icon: Users,
      title: 'Community',
      description: 'Building a global community of passionate travelers who share experiences and inspire each other.'
    },
    {
      icon: Award,
      title: 'Excellence',
      description: 'We deliver exceptional service and carefully curated experiences that exceed expectations.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-teal-800 text-white py-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-60 left-1/2 text-3xl animate-bounce" style={{animationDelay: '1.5s'}}>🌍</div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
            Creating extraordinary travel experiences and unforgettable events that connect people with the world's most amazing destinations and cultures.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="animate-fadeIn">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                To inspire wanderlust and create life-changing travel experiences that broaden horizons, 
                build connections, and foster a deeper understanding of our beautiful, diverse world.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700">Curated travel packages to exotic destinations worldwide</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <ChevronRight className="w-6 h-6 text-blue-500 mt-1" />
                    <p className="text-gray-700">Immersive cultural events and local festival experiences</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <ChevronRight className="w-6 h-6 text-blue-500 mt-1" />
                    <p className="text-gray-700">Adventure tours for thrill-seekers and nature lovers</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <ChevronRight className="w-6 h-6 text-blue-500 mt-1" />
                    <p className="text-gray-700">Custom event planning for corporate and private gatherings</p>
                  </div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-blue-500 to-teal-600 rounded-2xl p-8 text-white relative overflow-hidden">
                <div className="absolute top-4 right-4 text-4xl animate-spin" style={{animationDuration: '10s'}}>🧭</div>
                <h4 className="text-2xl font-bold mb-4">Our Vision</h4>
                <p className="text-lg opacity-90">
                  To become the world's most trusted travel companion, known for creating authentic, 
                  sustainable, and transformative experiences that connect people with the magic of exploration.
                </p>
              </div>
            </div>
            ...
            <div className="mb-16">
              <h3 className="text-3xl font-bold text-gray-800 mb-8 text-center">Popular Destinations</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {destinations.map((dest, index) => (
                  <div key={index} className="bg-white rounded-xl shadow-lg p-4 text-center hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105">
                    <div className="text-4xl mb-3 animate-bounce" style={{animationDelay: `${index * 0.2}s`}}>
                      {dest.emoji}
                    </div>
                    <h4 className="font-bold text-gray-800 mb-1">{dest.name}</h4>
        ...
        {activeTab === 'story' && (
          <div className="animate-fadeIn">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Born from a passion for exploration and a dream to share the world's wonders with fellow adventurers.
              </p>
            </div>
            ...
            <div className="space-y-12">
              <div className="bg-white rounded-2xl shadow-lg p-8 relative overflow-hidden">
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">The Adventure Begins</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Started as a small group of travel enthusiasts organizing weekend getaways for friends. 
                  Our first trip to the Blue Mountains attracted 12 adventurous souls and sparked the idea 
                  for something bigger - sharing the joy of discovery with the world.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 relative overflow-hidden">
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">Going Global</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Expanded to international destinations and launched our first cultural festival tour in India. 
                  The response was overwhelming - travelers loved experiencing authentic local celebrations and 
                  connecting with communities around the world.
                </p>
              </div>

              <div className="bg-white rounded-2xl shadow-lg p-8 relative overflow-hidden">
                <div className="absolute top-4 right-4 text-3xl animate-spin" style={{animationDuration: '5s'}}>🌟</div>
                <div className="flex items-center space-x-4 mb-6">
                  <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white font-bold">
                    2024
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800">Award-Winning Experiences</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Today, we're proud to be recognized as "Best Adventure Travel Company" and "Most Innovative Event Planner." 
                  With over 500,000 travelers served and partnerships with local communities in 150+ destinations, 
                  we continue to create magic one journey at a time.
                </p>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'values' && (
          <div className="animate-fadeIn">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                The principles that guide our adventures and shape every experience we create for our travelers.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              {values.map((value, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105 relative overflow-hidden">
        ...
        {activeTab === 'team' && (
          <div className="animate-fadeIn">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">Meet Our Adventure Guides</h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                The passionate explorers and cultural enthusiasts who make every journey extraordinary.
              </p>
            </div>
              ...
              {team.map((member, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105">
                  <div className={`h-32 bg-gradient-to-br ${member.color} flex items-center justify-center relative overflow-hidden`}>
                    ...
                    <div className="absolute top-2 right-2 text-2xl animate-spin" style={{animationDuration: '8s'}}>
                      ✨
                    </div>
                  </div>
                  <div className="p-6">
